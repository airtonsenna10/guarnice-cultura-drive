      ...
      <section className="w-full max-w-sm">
        <form onSubmit={submit} className="w-full bg-card border rounded-lg p-6 shadow-elevated">
          <header className="text-center mb-4">
            <img src="/lovable-uploads/f655a59c-4ce0-47ae-987d-f255a50b6af8.png" alt="Logo Guarnicé Frotas" className="h-16 md:h-20 mx-auto mb-3 object-contain" loading="lazy" decoding="async" />
